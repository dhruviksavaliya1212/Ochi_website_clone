  ...
  return (
    <div className="w-full rounded-t-2xl overflow-hidden h-full md:h-[40rem] bg-zinc-950 flex flex-wrap md:flex-nowrap items-center py-10 lg:px-16 px-5 gap-4">
      <div className="cardcontainer h-[20rem] md:w-1/2 w-full">
        <div data-aos="flip-right" data-aos-delay="100" className="relative card w-full rounded-xl h-full text-[#CDEA68]  bg-[#004D43] flex items-center justify-center">
          <img 
            className="w-36"
      ...
      <div className="cardcontainer flex items-center justify-center flex-col sm:flex-row  md:flex-nowrap gap-3 h-full md:w-1/2 w-full">
        <div data-aos="flip-right" data-aos-delay="100" className="card relative flex justify-center items-center w-full sm:w-1/2 rounded-xl h-[20rem] bg-[#313030]">
          <img
            className="w-36"
        ...
        <div data-aos="flip-right" data-aos-delay="100" className="card relative flex items-center justify-center w-full sm:w-1/2 rounded-xl h-[20rem] bg-[#212121]">
          <img
            className="w-28"
